#!/usr/bin/env python3
"""Test differential engine with multiple archetypes."""
import asyncio
...
async def test():
    ...
    for p in patients[:5]:
        ...
        if p['archetype'] == 'uncontrolled_dm':
        ...
        elif p['archetype'] == 'faltering_growth':
        ...
        elif p['archetype'] == 'high_risk_anc':
        ...
        elif p['archetype'] == 'polypharmacy_elderly':
        ...
        files = glob.glob('data/patients/' + p['archetype'] + '_*.json')
        ...
        print('=== ' + p['archetype'] + ' (' + p['name'] + ', ' + str(p['age']) + p['gender'] + ') ===')
